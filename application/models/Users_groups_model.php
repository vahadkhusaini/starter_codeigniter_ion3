...
class Users_groups_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(site_url('users_groups/read/$1'),'Read')." | ".anchor(site_url('users_groups/update/$1'),'Update')." | ".anchor(site_url('users_groups/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
