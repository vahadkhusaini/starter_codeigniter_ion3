...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		else
		{
			...
			$this->data['role'] = $this->ion_auth->groups()->result();
	...
	public function create_user()
	{
		...
		// validate form input
		$this->form_validation->set_rules('groups[]', 'Role Akses', 'required');
	...
	public function delete_user()
	{
		...
		if($id == 1){
			$this->session->set_flashdata('message', ' 
				<div class="alert alert-danger alert-dismissible">
					<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
					<h4><i class="icon fa fa-check"></i> Akses Di larang !</h4>
				</div>');
		}else{
	...
	*/
	...
	public function create_group()
	{
		...
		// validate form input
		$this->form_validation->set_rules('group_name', $this->lang->line('create_group_validation_name_label'), 'trim|required|alpha_dash|is_unique[' . $tables['groups'] . '.name]');
	...
	public function delete_group()
	{
		...
		$data['group_id'] = $this->db->get_where('users_groups', array('group_id' => $group_id))->row_array();

		if($data['group_id']['group_id'] == null )
		{
		...
		{			
			...
			Role akses masih terhubung dengan pengguna
			</div>');
		}
